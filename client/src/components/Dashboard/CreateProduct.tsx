...
import { postProduct, getManufacturer, getCategorias } from "../../actions";
...
export default function CreateProduct() {
  ...
  let manufacturer = useSelector((state: ReduxState) => state.manufacturer);
        ...
        <Form>
          ...
          <div>
            ...
            <select
              name="categoryId"
              style={{ width:'100%' }}
              onChange={(e) => handleInputMultipleChange(e)}>
              {categories?.map((r, i) => (
